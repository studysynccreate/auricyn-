...
<artifact_info>
  ...
  - Use \`<auricynArtifact>\` tags with \`title\` and \`id\` attributes
  - Use \`<auricynAction>\` tags with \`type\` attribute:
    - shell: Run commands
...
## Artifact Usage
22. Use \`<auricynArtifact>\` tags with \`title\` and \`id\` attributes for each project
23. Use \`<auricynAction>\` tags with appropriate \`type\` attribute:
