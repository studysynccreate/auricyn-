...
describe('StreamingMessageParser', () => {
  ...
  describe('no artifacts', () => {
    ...
    ])('should correctly parse chunks and strip out auricyn artifacts (%#)', (input, expected) => {
  ...
  describe('invalid or incomplete artifacts', () => {
    it.each<[string | string[], ExpectedResult | string]>([
      ...
      ['Foo bar <bol', 'Foo bar '],
      ['Foo bar <auricyn', 'Foo bar '],
      ['Foo bar <auricyna', 'Foo bar <auricyna'],
      ['Foo bar <auricynA', 'Foo bar '],
      ['Foo bar <auricynArtifacs></auricynArtifact>', 'Foo bar <auricynArtifacs></auricynArtifact>'],
      ['Before <oltArtfiact>foo</auricynArtifact> After', 'Before <oltArtfiact>foo</auricynArtifact> After'],
      ['Before <auricynArtifactt>foo</auricynArtifact> After', 'Before <auricynArtifactt>foo</auricynArtifact> After'],
    ])('should correctly parse chunks and strip out auricyn artifacts (%#)', (input, expected) => {
      runTest(input, expected);
    });
  });
  ...
  describe('valid artifacts without actions', () => {
    it.each<[string | string[], ExpectedResult | string]>([
      [
        'Some text before <auricynArtifact title="Some title" id="artifact_1">foo bar</auricynArtifact> Some more text',
        {
      ...
      [
        [
          'Some text before <auricynArti',
          'fact',
          ' title="Some title" id="artifact_1" type="bundled" >foo</auricynArtifact> Some more text',
        ],
        {
          output: 'Some text before  Some more text',
          callbacks: { onArtifactOpen: 1, onArtifactClose: 1, onActionOpen: 0, onActionClose: 0 },
      ...
      [
        [
          ...
          ' ',
          '>',
          'foo</auricynArtifact> Some more text',
        ],
        {
          output: 'Some text before  Some more text',
          callbacks: { onArtifactOpen: 1, onArtifactClose: 1, onActionOpen: 0, onActionClose: 0 },
      ...
      [
        [
          ...
          ' >fo',
          'o</auricynArtifact> Some more text',
        ],
        {
          output: 'Some text before  Some more text',
          callbacks: { onArtifactOpen: 1, onArtifactClose: 1, onActionOpen: 0, onActionClose: 0 },
      ...
      [
        [
          ...
          'o',
          '<',
          '/auricynArtifact> Some more text',
        ],
        {
          output: 'Some text before  Some more text',
          callbacks: { onArtifactOpen: 1, onArtifactClose: 1, onActionOpen: 0, onActionClose: 0 },
      ...
      [
        'Before <auricynArtifact title="Some title" id="artifact_1">foo</auricynArtifact> After',
        {
          output: 'Before  After',
          callbacks: { onArtifactOpen: 1, onArtifactClose: 1, onActionOpen: 0, onActionClose: 0 },
        },
  ...
  describe('valid artifacts with actions', () => {
    it.each<[string | string[], ExpectedResult | string]>([
      [
        'Before <auricynArtifact title="Some title" id="artifact_1"><auricynAction type="shell">npm install</auricynAction></auricynArtifact> After',
        {
          output: 'Before  After',
      ...
      [
        'Before <auricynArtifact title="Some title" id="artifact_1"><auricynAction type="shell">npm install</auricynAction><auricynAction type="file" filePath="index.js">some content</auricynAction></auricynArtifact> After',
        {
          output: 'Before  After',
