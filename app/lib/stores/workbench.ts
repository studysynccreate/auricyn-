...
export class WorkbenchStore {
  ...
  get auricynTerminal() {
    return this.#terminalStore.auricynTerminal;
  }
  get alert() {
  ...
  attachAuricynTerminal(terminal: ITerminal) {
    this.#terminalStore.attachAuricynTerminal(terminal);
  }
