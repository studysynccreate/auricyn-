...
const storedProfile = typeof window !== 'undefined' ? localStorage.getItem('auricyn_profile') : null;
...
export const updateProfile = (updates: Partial<Profile>) => {
  ...
  if (typeof window !== 'undefined') {
    localStorage.setItem('auricyn_profile', JSON.stringify(profileStore.get()));
  }
};
