      ...
      >
        <div
          className={classNames(
            ...
            'p-1 rounded-lg text-auricyn-elements-item-contentAccent',
            'flex ',
          )}
        >
          ...
          <motion.button
            ...
            className=" p-1 rounded-lg bg-auricyn-elements-item-backgroundAccent hover:bg-auricyn-elements-artifacts-backgroundHover"
