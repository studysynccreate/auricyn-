...
export function WebSearch({ onSearchResult, disabled = false }: WebSearchProps) {
  ...
  return (
    <div ref={containerRef} className="relative">
      ...
      >
        {isSearching ? (
          <div className="i-svg-spinners:90-ring-with-bg text-auricyn-elements-loader-progress text-xl animate-spin" />
        ) : (
      ...
      {isOpen && (
        <div
          className={classNames(
            ...
            'rounded-lg border border-auricyn-elements-borderColor bg-auricyn-elements-background-depth-2 p-2 shadow-lg',
          )}
        >
          <input
            ref={inputRef}
            ...
            className={classNames(
              ...
              'bg-auricyn-elements-background-depth-1 text-auricyn-elements-textPrimary',
              'placeholder-auricyn-elements-textTertiary',
          ...
          <button
            ...
            className={classNames(
              ...
              'bg-auricyn-elements-button-primary-background text-auricyn-elements-button-primary-text',
