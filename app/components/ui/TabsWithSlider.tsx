        ...
        <button
          ...
          className={classNames(
            ...
            tab.id === activeTab
              ...
              : classNames(
                  'bg-auricyn-elements-background-depth-2 dark:bg-auricyn-elements-background-depth-3 text-auricyn-elements-textPrimary dark:text-auricyn-elements-textPrimary-dark hover:bg-auricyn-elements-background-depth-3 dark:hover:bg-auricyn-elements-background-depth-4 border border-auricyn-elements-borderColor dark:border-auricyn-elements-borderColor-dark',
                  tabClassName,
                ),
          )}
        >
