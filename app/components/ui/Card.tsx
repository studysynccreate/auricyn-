  ...
  return (
    <div
      ...
      className={classNames(
        'rounded-lg border border-auricyn-elements-borderColor bg-auricyn-elements-background-depth-1 text-auricyn-elements-textPrimary shadow-sm',
        className,
      )}
      {...props}
    />
...
const CardDescription = forwardRef<HTMLParagraphElement, React.HTMLAttributes<HTMLParagraphElement>>(
  ({ className, ...props }, ref) => {
    return <p ref={ref} className={classNames('text-sm text-auricyn-elements-textSecondary', className)} {...props} />;
  },
);
