      ...
      <div className="flex items-center gap-1.5">
        ...
        <span
          className={classNames(
            isLast
              ? 'font-medium text-auricyn-elements-textPrimary dark:text-auricyn-elements-textPrimary-dark'
              : 'text-auricyn-elements-textSecondary dark:text-auricyn-elements-textSecondary-dark hover:text-auricyn-elements-textPrimary dark:hover:text-auricyn-elements-textPrimary-dark',
            ...
            <li key={index} className="flex items-center">
              ...
              {!isLast && (
                <span
                  className={classNames(
                    separator,
                    'w-3 h-3 mx-1 text-auricyn-elements-textTertiary dark:text-auricyn-elements-textTertiary-dark',
                  )}
                />
              )}
            </li>
