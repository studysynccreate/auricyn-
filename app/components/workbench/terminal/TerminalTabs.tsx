  ...
  return (
    ...
    >
      <div className="h-full">
        <div className="bg-auricyn-elements-terminals-background h-full flex flex-col">
          <div className="flex items-center bg-auricyn-elements-background-depth-2 border-y border-auricyn-elements-borderColor gap-1.5 min-h-[34px] p-2">
                  ...
                  {index == 0 ? (
                    <button
                      ...
                      className={classNames(
                        ...
                        {
                          'bg-auricyn-elements-terminals-buttonBackground text-auricyn-elements-textSecondary hover:text-auricyn-elements-textPrimary':
                            isActive,
                          'bg-auricyn-elements-background-depth-2 text-auricyn-elements-textSecondary hover:bg-auricyn-elements-terminals-buttonBackground':
                            !isActive,
                        },
                      )}
                    ...
                    <React.Fragment>
                      <button
                        ...
                        className={classNames(
                          'flex items-center text-sm cursor-pointer gap-1.5 px-3 py-2 h-full whitespace-nowrap rounded-full',
                          {
                            'bg-auricyn-elements-terminals-buttonBackground text-auricyn-elements-textPrimary': isActive,
                            'bg-auricyn-elements-background-depth-2 text-auricyn-elements-textSecondary hover:bg-auricyn-elements-terminals-buttonBackground':
                              !isActive,
                          },
                        )}
                      ...
                      >
                        ...
                        <button
                          className="bg-transparent text-auricyn-elements-textTertiary hover:text-auricyn-elements-textPrimary hover:bg-transparent rounded"
                          onClick={(e) => {
                            e.stopPropagation();
                            closeTerminal(index);
                          }}
            ...
            <IconButton
              ...
              onClick={() => {
                ...
                if (ref?.getTerminal()) {
                  ...
                  if (activeTerminal === 0) {
                    workbenchStore.attachAuricynTerminal(terminal);
                  } else {
          ...
          {Array.from({ length: terminalCount + 1 }, (_, index) => {
            ...
            logger.debug(`Starting auricyn terminal [${index}]`);
              ...
              return (
                <React.Fragment key={`terminal-container-${index}`}>
                  <Terminal
                    ...
                    onTerminalReady={(terminal) => workbenchStore.attachAuricynTerminal(terminal)}
